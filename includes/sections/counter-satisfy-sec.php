<div class="container">
    <div class="counter-satisfy-inner">
        <div class="counter-satisfy-head">
            <h2 class="heading-three">WE ARE ONE OF THE MOST INNOVATIVE APP DEVELOPMENT COMPANIES OF THE USA</h2>
            <p>Hoff & Mazor has helped more than 500 companies in strengthening their brand awareness by creating apps with innovative, and attractive UI/UX Designs. We design customized strategies as per clients’ needs. Customer satisfaction fuels us to keep going.</p>
        </div>
        <div class="counter-satisfy-items">
            ...
            <div class="counter-satisfy-box">
                ...
                <p>Developer <br> Recruitment Process</p>
            </div>
            <div class="counter-satisfy-box">
                <div class="counter-box-img">
            ...
            <div class="counter-satisfy-box">
                ...
                <p>Downloads by <br> Cilent Customers</p>
            </div>
        </div>
    </div>
</div>