            ...
            <div class="row justify-content-center">
                <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                    <div class="terms-privacy-content">
                        ...
                        <p>The use of this website and/or our services constitutes your agreement to the following terms and conditions:If you do not agree with any of these terms and conditions, please do not use this Website or Our services.If you are under legal age of consent for your respective district than you are not allowed to access or use this Website or Our services. You acknowledge and agree that you must be of legal age to purchase any of our products or services available on this Website or otherwise.By submitting an order and/or payment, you are acknowledging that you have read and understood these terms and conditions. You are also agreeing to be legally bound by these terms and conditions, which form the entire agreement between You and penguinbookwriters.com/. By submitting an order and/or payment, you are acknowledging that you have read and understood these terms and conditions. You are also agreeing to be legally bound by these terms and conditions, which form the entire agreement between You and <strong>penguinbookwriters.com/</strong>.</p>
                        
                        <h3 class="heading-four">Definition Of Terms</h3>
                        <p><strong>"Website"</strong> means all online content on <strong>penguinbookwriters.com/</strong> website pages.</p>
                        <p><strong>"Customer," "You," "Yours"</strong> or means and refers to you and or any other person submitting an order to <strong>penguinbookwriters.com/</strong> on your behalf.</p>
                        <p><strong>"Company," "We," "Our"</strong> or means and refers to <strong>penguinbookwriters.com/</strong>, a company registered under the laws of the State.</p>
                        <p><strong>"Product or Services"</strong> means and refers to all services and products provided by <strong>penguinbookwriters.com/</strong> to customer in accordance with his/ her order.</p>
                        <p><strong>"Order"</strong> means an order via phone or e-mail made by customer to purchase services or products provided by <strong>penguinbookwriters.com/</strong>. Orders are confirmed by down payments via check, credit card, cash receipt, bank wire transfer, Western Union, or PayPal transfer.</p>

                        <h3 class="heading-four">Our Services</h3>
                        <p>It is important that you carefully read and understand the refund policy in order to have full knowledge of the privileges and limitations governed by the Penguin Book Writers Policy. It is your obligation to read these Terms and Conditions before submitting any Order and/ or payment to this Website.</p>
